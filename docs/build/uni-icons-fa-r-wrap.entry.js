...
const UniIconsFaRegularWrapComponent = class {
  constructor(hostRef) {
...
UniIconsFaRegularWrapComponent.style = iconsFaRegularCss;

export { UniIconsFaRegularWrapComponent as uni_icons_fa_r_wrap };
