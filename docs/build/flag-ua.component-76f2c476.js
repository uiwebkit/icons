...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-ua" viewBox="0 0 640 480">
...
const squareSvg = `<svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-ua" viewBox="0 0 512 512">
  <g fill-rule="evenodd" stroke-width="1pt">
...
const UniFlagUaComponent = class {
  constructor(hostRef) {
...
export { UniFlagUaComponent as U };
