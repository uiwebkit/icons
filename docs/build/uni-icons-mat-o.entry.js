...
const UniIconsMatOutlineComponent = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.spin = false;
  }
  render() {
    return UniTemplate(h(Host, { class: 'material-icons-outlined' }, h("slot", null), this.name));
  }
  componentDidRender() {
...
UniIconsMatOutlineComponent.style = iconsMatOutlineCss;

export { UniIconsMatOutlineComponent as uni_icons_mat_o };
