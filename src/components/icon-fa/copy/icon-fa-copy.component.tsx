...
@Component({ tag: 'uni-icon-fa-copy' })
export class UniIconFaCopyComponent implements ComponentInterface {
  ...
  render(): VNode {
    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props} width={size} height={size}>
        <path
