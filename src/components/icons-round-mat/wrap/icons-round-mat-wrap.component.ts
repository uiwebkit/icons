...
@Component({
  tag: 'uni-icons-round-mat-wrap',
  styleUrl: '../styles/icons-round-mat.css',
})
export class UniIconsRoundMatWrapComponent implements ComponentInterface {
  ...
  onActiveChanged(newValue: boolean): void {
    if (newValue) {
      uniAddClasses(this.data, ['material-icons-round'], 'uni-icons-round-mat-wrap');
      this.active = false;
    }
  }
