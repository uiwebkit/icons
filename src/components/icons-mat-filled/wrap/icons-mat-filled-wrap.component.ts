...
@Component({
  tag: 'uni-icons-mat-filled-wrap',
  styleUrl: '../styles/icons-mat-filled.css',
})
export class UniIconsMatFilledWrapComponent implements ComponentInterface {
  ...
  onActiveChanged(newValue: boolean): void {
    if (newValue) {
      uniAddClasses(this.data, ['material-icons'], 'uni-icons-mat-filled-wrap');
      this.active = false;
    }
  }
