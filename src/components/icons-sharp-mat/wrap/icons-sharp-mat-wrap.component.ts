...
@Component({
  tag: 'uni-icons-sharp-mat-wrap',
  styleUrl: '../styles/icons-sharp-mat.css',
})
export class UniIconsSharpMatWrapComponent implements ComponentInterface {
  ...
  onActiveChanged(newValue: boolean): void {
    if (newValue) {
      uniAddClasses(this.data, ['material-icons-sharp'], 'uni-icons-sharp-mat-wrap');
      this.active = false;
    }
  }
