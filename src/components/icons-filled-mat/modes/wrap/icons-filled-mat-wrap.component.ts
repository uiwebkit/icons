...
@Component({
  tag: 'uni-icons-filled-mat-wrap',
  styleUrl: '../../styles/icons-filled-mat.css',
})
export class UniIconsFilledMatWrapComponent implements ComponentInterface {
  ...
  onActiveChanged(newValue: boolean): void {
    if (newValue) {
      uniAddClasses(this.data, ['material-icons'], 'uni-icons-filled-mat-wrap');
      this.active = false;
    }
  }
